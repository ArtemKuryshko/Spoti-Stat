...
export default async function TestPage() {
    const { data: { artists: { items: artists } } } = await ArtistsService.getArtists();
    const { data: { items: [topListenedArtist] } } = await ArtistsService.getTopListenedArtist();
    ...
    return (
        <div>
                    ...
                    <li key={artist.id} className="mb-4 p-4 bg-zinc-800 rounded-lg">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-zinc-400">{artist.followers.total.toLocaleString()} followers</p>
            ...
            <div key={topListenedArtist.id} className="mb-4 p-4 bg-zinc-800 rounded-lg">
                <div className="flex items-start gap-4">
                    <img
                    ...
                    <div>
                        ...
                        <p className="text-zinc-400">{topListenedArtist.followers.total.toLocaleString()} followers</p>
                        <p className="text-zinc-500 text-sm mt-1">
